...
/*public final class ModPackets {
    ...
    public static void registerCommon() {
        ...
        fr.lordfinn.crazyphone.network.CrazyPhoneAddPhotoToMyPhotosPacket.registerFabricType();
        ...
        fr.lordfinn.crazyphone.network.CrazyPhoneIncomingCallNotificationPacket.registerFabricType();
        fr.lordfinn.crazyphone.network.CallParticipantHeadRotationSyncPacket.registerFabricType();
        fr.lordfinn.crazyphone.network.CrazyPhoneConversationButtonMessage.registerFabricType();
        fr.lordfinn.crazyphone.network.CrazyPhoneMuteConversationMessage.registerFabricType();
    ...
    public static void registerClient() {
        ...
        fr.lordfinn.crazyphone.network.CrazyPhoneIncomingCallNotificationPacket.registerFabricClientReceiver();
        fr.lordfinn.crazyphone.network.CallParticipantHeadRotationSyncPacket.registerFabricClientReceiver();
    ...
    public static void registerServer() {
        ...
        fr.lordfinn.crazyphone.network.CrazyPhoneAddPhotoToMyPhotosPacket.registerFabricServerReceiver();
        ...
        fr.lordfinn.crazyphone.network.CrazyPhoneMuteConversationMessage.registerFabricServerReceiver();
