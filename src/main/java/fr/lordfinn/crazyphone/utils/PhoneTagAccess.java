...
public final class PhoneTagAccess {
    ...
    /** Sets a registered phone's own translated "CrazyPhone de {owner}" display name. */
    public static void setPhoneDisplayName(ItemStack stack, String ownerName) {
        setCustomName(stack, Component.translatable("item.crazyphone.custom_name", ownerName));
    }
