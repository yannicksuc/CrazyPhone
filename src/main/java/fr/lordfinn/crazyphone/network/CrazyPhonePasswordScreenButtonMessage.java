...
//?}
//? if legacyforge {
/*public record CrazyPhonePasswordScreenButtonMessage(int buttonID, int x, int y, int z, HashMap<String, String> textstate) {
*///? } else {
...
//?}
	...
	*///? } else {
	...
	//?}
	//? if fabric && >=1.20.5 {
	/*public static void handleDataFabric(CrazyPhonePasswordScreenButtonMessage message, net.fabricmc.fabric.api.networking.v1.ServerPlayNetworking.Context context) {
	...
	*///? } else {
	...
	public static void registerFabricServerReceiver() {
		fr.lordfinn.crazyphone.fabric.FabricNetworking.registerServerReceiver(TYPE, CrazyPhonePasswordScreenButtonMessage::handleDataFabric);
	}
	*///?}
