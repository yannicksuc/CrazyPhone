...
//?}
//? if legacyforge {
/*public record CrazyPhoneSignInScreenButtonMessage(int buttonID, int x, int y, int z, HashMap<String, String> textstate) {
*///? } else {
...
//?}
	...
	*///? } else {
	public static final /*$ res_loc {*/ResourceLocation/*$}*/ ID = new /*$ res_loc {*/ResourceLocation/*$}*/(Crazyphone.MODID, "crazy_phone_sign_in_screen_buttons");
	...
	*///? } else {
	...
	//?}
	//? if fabric && >=1.20.5 {
	/*public static void handleDataFabric(CrazyPhoneSignInScreenButtonMessage message, net.fabricmc.fabric.api.networking.v1.ServerPlayNetworking.Context context) {
	...
	*///? } else {
	...
	public static void registerFabricServerReceiver() {
		fr.lordfinn.crazyphone.fabric.FabricNetworking.registerServerReceiver(TYPE, CrazyPhoneSignInScreenButtonMessage::handleDataFabric);
	}
	*///?}
    ...
    //? if legacyforge {
    @EventBusSubscriber(bus = EventBusSubscriber.Bus.MOD)
    public static class CrazyPhoneSignInScreenButtonMessageLegacyForgeRegistration {
        @SubscribeEvent
        public static void register(FMLCommonSetupEvent event) {
            Crazyphone.addNetworkMessage(CrazyPhoneSignInScreenButtonMessage.class, 25, CrazyPhoneSignInScreenButtonMessage::write, CrazyPhoneSignInScreenButtonMessage::new, CrazyPhoneSignInScreenButtonMessage::handleData);
        }
    }
    //?}
}