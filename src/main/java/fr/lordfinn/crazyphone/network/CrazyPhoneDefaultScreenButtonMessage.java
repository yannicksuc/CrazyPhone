...
//?}
	...
	*///? } else {
	public static final /*$ res_loc {*/ResourceLocation/*$}*/ ID = new /*$ res_loc {*/ResourceLocation/*$}*/(Crazyphone.MODID, "crazy_phone_default_screen_buttons");
	...
	*///? } else {
	...
	//?}
	//? if fabric && >=1.20.5 {
	/*public static void handleDataFabric(CrazyPhoneDefaultScreenButtonMessage message, net.fabricmc.fabric.api.networking.v1.ServerPlayNetworking.Context context) {
	...
	*///?}
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z, HashMap<String, String> textstate) {
		...
		if (buttonID == 0) {
			...
			if (stack.getItem() == ModItems.CRAZY_PHONE.get() && entity instanceof ServerPlayer serverPlayer) {
				ScreenMenuUtils.resetToHomeScreen(serverPlayer);
				ScreenMenuUtils.openPhoneCustomMenu(serverPlayer, InteractionHand.MAIN_HAND, CrazyphoneHomeScreenMenu.class);
			}
			*///?}
		} else if (buttonID == 2) {
	...
	*///?}
    ...
    //? if legacyforge {
    @EventBusSubscriber(bus = EventBusSubscriber.Bus.MOD)
    public static class CrazyPhoneDefaultScreenButtonMessageLegacyForgeRegistration {
        @SubscribeEvent
        public static void register(FMLCommonSetupEvent event) {
            Crazyphone.addNetworkMessage(CrazyPhoneDefaultScreenButtonMessage.class, 11, CrazyPhoneDefaultScreenButtonMessage::write, CrazyPhoneDefaultScreenButtonMessage::new, CrazyPhoneDefaultScreenButtonMessage::handleData);
        }
    }
    //?}
}