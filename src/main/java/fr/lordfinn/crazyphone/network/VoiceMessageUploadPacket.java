 ...
 */
//? if legacyforge {
/*public record VoiceMessageUploadPacket(String conversationId, UUID voiceId, byte[] audioPcm, int durationTicks, byte[] envelope) {
*///? } else {
...
//?}
    ...
    *///? } else {
    public static final /*$ res_loc {*/ResourceLocation/*$}*/ ID = Crazyphone.resource("voice_message_upload");
