 ...
 */
//? if legacyforge {
/*public record ConversationRequestPacket(String conversationId, int skipFromEnd) {
*///? } else {
...
//?}
    ...
    *///? } else {
    public static final /*$ res_loc {*/ResourceLocation/*$}*/ ID = new /*$ res_loc {*/ResourceLocation/*$}*/(Crazyphone.MODID, "conversation_request");
